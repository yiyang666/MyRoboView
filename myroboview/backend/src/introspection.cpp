...
Decoder::Decoder(const std::string &type) {
  ...
  auto cpp = rclcpp::get_message_typesupport_handle(type, "rosidl_typesupport_cpp", *cpp_library_);
  auto meta = rclcpp::get_message_typesupport_handle(type, "rosidl_typesupport_introspection_cpp", *introspection_library_);
