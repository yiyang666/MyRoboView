// Adapted from the original RoboView Sidebar; ROS2 demo exposes only read-only pages.
...
export default function Sidebar({ selectedMenu, onMenuSelect }) {
  return <div className="sidebar">
    ...
    <div className="sidebar-footer"><div className="version-info">ROS2 C++ · Demo 0.1<br />只读监控 · 复用 RoboView 界面</div></div>
  </div>;
}
