...
export const URDF_CONFIG = {
  ...
  // 开发态：start_dev.sh 同步到 public/assets/robot_urdf/；
  // 安装态：CMake 将 asserts/<产品>/robot_urdf 装到 etc/web/assets/robot_urdf/
  // 注意：当前未挂载 3D viewer，本路径仅作配置备查
  urdfPath: '/assets/robot_urdf/LRS-X2URDF.urdf',

  // package:// 前缀到静态资源目录的映射（与 URDF 内 package 名一致）
  packages: {
    'lrs-x': '/assets/robot_urdf/',
  },
